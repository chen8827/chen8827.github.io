...
mrtdata=pd.read_csv('basic/mrt.csv',header=0)
bardata=pd.read_csv('basic/bar.csv',header=0)
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div(
            ...
            children=[
                html.H1('B A R M A P'),
                html.Iframe(id='map',srcDoc=open('basic/map.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                ...
                html.Br(),
                html.Iframe(id='BRmap',srcDoc=open('basic/BRmap.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                ...
                html.Br(),
                html.Iframe(id='Rmap',srcDoc=open('basic/Rmap.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                ...
                html.Br(),
                html.Iframe(id='Gmap',srcDoc=open('basic/Gmap.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                ...
                html.Br(),
                html.Iframe(id='Omap',srcDoc=open('basic/Omap.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                ...
                html.Br(),
                html.Iframe(id='BLmap',srcDoc=open('basic/BLmap.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                ...
                html.Br(),
                html.Iframe(id='Ymap',srcDoc=open('basic/Ymap.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
        ...
        html.Div(
            ...
            children=[
                ...
                html.Br(),
                html.Iframe(id='Amap',srcDoc=open('basic/Amap.html','r',encoding='utf-8').read(),width='600px',height='600px')
            ]
        ),
